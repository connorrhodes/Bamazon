...
var colors = require('colors/safe');//enables different colors to be used for UI node text
var Table = require('cli-table');//enables a neater node UI for the tables called
var connection = mysql.createConnection({//sql connection
	host: 'localhost',
	user: 'root',
	password: 'fejwqkte',
	database: 'Bamazon', 
...
var managerOptions = {
	properties:{
		mOptions:{
			description: colors.blue('Key in one of the following options: 1) View Products for Sale 2) View Low Inventory 3) Add New Product')
		},
	},
};
